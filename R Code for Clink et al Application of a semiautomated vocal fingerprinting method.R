    ...
    source("/Users/denasmacbook/Desktop/MFCC-Vocal-Fingerprinting-master/SVM-RFE-master/msvmRFE.R")
    ...
    ##### Part 3 Comparison of LDA with different feature extraction methods
    ...
    mfcc.den.df <- read.csv("/Users/denasmacbook/Desktop/Clink_et_at_MFCC/mfcc.density.dataframe.feature.extraction.method.1.csv")
    ...
    sum(diag(prop.table(
      table(mod.pred, mfcc.data.season.3$female.id.test) ## 92.3 % accuracy
    )))
